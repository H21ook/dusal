...
const Header = ({
    ...
    return (
        <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-2xl supports-backdrop-filter:bg-background/60 pt-[calc(env(safe-area-inset-top,16px)+1px)]">
